...
form.addEventListener("submit", (e) => {
  ...
  document.querySelectorAll(".rep-quiz").forEach((ul) => {
    ...
    options.forEach((li) => {
      li.addEventListener("click", () => {
        ...
        if (li.classList.contains("correct")) {
          ...
          ul.querySelector(".correct").classList.add("selected", "correct");
        }
      });
    });
  });
...
//   faire un scroll 
// check formulaire 
// pour le boutton de mon site quand j'appuie faut qu'il fasse défiler vers la première section 